...
public class ObjectLoader {
	...
	public static Mesh loadObjectEBO(String objectName) {
		...
		System.out.println("[loadingLog] Loaded Object " + objectName + " with " + indexMap.size() + " vertices " + "and " + indizesList.size() / 3 + " faces");
	...
	public static float[] loadObject(String objectName) {
		...
		System.out.println("[loadingLog] Loaded Object " + objectName + " with " + vertices.size() + " vertices and " + data.size() / 8 / 3 + " faces");
		return dataArray;
	}
}
