...
public class PointLight extends Light {
    ...
    public PointLight(Vector3f ambient, Vector3f diffuse, Vector3f specular, Vector3f position, float constant, float linear, float quadratic) {
    ...
    public PointLight(Color color, float intensity, Vector3f position, float reach) {
     ...
     *
     * @param distance the desired reach distance of the light
     ...
     * http://www.learnopengl.com/#!Lighting/Light-casters based on this
     * function restorer: http://www.arndt-bruenner.de/mathe/scripts/regrnl.htm
     * @param distance the desired distance for the light
